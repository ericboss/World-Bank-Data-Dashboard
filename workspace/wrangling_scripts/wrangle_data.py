...
# fourth chart shows rural population vs arable land
    ...
    graph_six = []
    df_six = cleandata('data/API_SP.RUR.TOTL_DS2_en_csv_v2_9914824.csv', ['Country Name', '2015'], ['2015'])

    mean_pop = df_six.groupby('country').mean()['variable']
    idxs = mean_pop.index.tolist() 
    ...
    layout_six = dict(title = 'Distribution of Mean Rural Population in 2015',
                xaxis = dict(title = 'Country'),
                yaxis = dict(title = 'Mean Rural Population'))
